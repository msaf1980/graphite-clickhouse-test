...
func GraphiteClickhouseStart(bin, configTpl, testDir, chAddr, config string) (*GraphiteClickhouse, error) {
	var err error
	...
	c := &GraphiteClickhouse{bin: bin, configTpl: configTpl}
...
func (c *GraphiteClickhouse) Stop() error {
	if c.cmd == nil {
		return nil
	}
	var err error
